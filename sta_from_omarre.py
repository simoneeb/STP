...
fpstim  = f'/user/sebert/home/Documents/Experiments/Spatiotemporal_tuning_curves/stimuli/{experiment_name}_checker/checkerboard_nd4_stim.mat'
...
for cell in tqdm(range(nb_cells)):
    ...
    fpout =f'/user/sebert/home/Documents/Experiments/Spatiotemporal_tuning_curves/STA/{experiment_name}/'
    ...
    data[key] = {}
    data[key]['sta'] = sta
    data[key]['space_rf'] = space_rf
    data[key]['time_rf'] = time_rf
    data[key]['pol'] = pol
    data[key]['nb_spks'] = nb_spks
